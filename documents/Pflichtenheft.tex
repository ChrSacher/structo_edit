...
% u read here https://de.wikipedia.org/wiki/Nassi-Shneiderman-Diagramm
	...
	\includegraphics[scale=.5]{LineareAnw.png} 
	\item Einfache Verzweigung\\
	
	\includegraphics[scale=.5]{EinfAusw.png} 
	\item Alternative Verzweigung\\
	
	\includegraphics[scale=.5]{ZweifAusw.png}
	\item Fallauswahl\\
	
	\includegraphics[scale=.5]{Fallauswahl.png} 
	\item Zählergesteuerte Schleife\\
	
	\includegraphics[scale=.5]{Zaehlschleife.png} 
	\item Kopfgesteuerte Schleife\\
	
	\includegraphics[scale=.5]{KopfgesteuerteSchleife.png} 
	\item Fußgesteuerte Schleife\\
	
	\includegraphics[scale=.5]{FussgesteuerteSchleife.png} 
	\item Endlosschleife\\
	
	\includegraphics[scale=.5]{Endlosschleife.png} 
	\item Aussprung\\
	
	\includegraphics[scale=.5]{Aussprung.png} 
	\item Aufruf\\
	
	\includegraphics[scale=.5]{Aufruf.png} 
